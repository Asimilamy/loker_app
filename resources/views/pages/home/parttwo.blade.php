    ...
    <ul class="owl-carousel testimonials list-unstyled equal-height">
        ...
        <div class="testimonial d-flex flex-wrap">
            ...
            <div class="testimonial-info d-flex">
                ...
                <div class="avatar"><img alt="" src="{{ asset('assets/img/person-1.jpg') }}" class="img-fluid"></div>
            </div>
            </div>
        </div>
        </li>
        ...
        <div class="testimonial d-flex flex-wrap">
            ...
            <div class="testimonial-info d-flex">
                ...
                <div class="avatar"><img alt="" src="{{ asset('assets/img/person-2.jpg') }}" class="img-fluid"></div>
            </div>
            </div>
        </div>
        </li>
        ...
        <div class="testimonial d-flex flex-wrap">
            ...
            <div class="testimonial-info d-flex">
                ...
                <div class="avatar"><img alt="" src="{{ asset('assets/img/person-3.png') }}" class="img-fluid"></div>
            </div>
            </div>
        </div>
        </li>
        ...
        <div class="testimonial d-flex flex-wrap">
            ...
            <div class="testimonial-info d-flex">
                ...
                <div class="avatar"><img alt="" src="{{ asset('assets/img/person-4.jpg') }}" class="img-fluid"></div>
            </div>
            </div>
        </div>
        </li>
