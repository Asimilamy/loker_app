<section class="bg-white bar">
    ...
    <div class="row">
        ...
        <div class="home-blog-post">
            <div class="image"><img src="{{ asset('assets/img/portfolio-4.jpg') }}" alt="..." class="img-fluid">
        ...
        <div class="col-lg-3">
        <div class="home-blog-post">
            <div class="image"><img src="{{ asset('assets/img/portfolio-3.jpg') }}" alt="..." class="img-fluid">
            <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
            </div>
            <div class="text">
        ...
        <div class="col-lg-3">
        <div class="home-blog-post">
            <div class="image"><img src="{{ asset('assets/img/portfolio-5.jpg') }}" alt="..." class="img-fluid">
            <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
            </div>
            <div class="text">
        ...
        <div class="col-lg-3">
        <div class="home-blog-post">
            <div class="image"><img src="{{ asset('assets/img/portfolio-6.jpg') }}" alt="..." class="img-fluid">
            <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
            </div>
            <div class="text">
            <h4><a href="#">Fashion Now </a></h4>
