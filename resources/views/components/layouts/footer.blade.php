<footer class="main-footer">
    ...
    <div class="row">
        ...
        <ul class="list-unstyled footer-blog-list">
            ...
            <div class="image"><img src="{{ asset('assets/img/detailsquare.jpg') }}" alt="..." class="img-fluid"></div>
            <div class="text">
        ...
        <ul class="list-inline photo-stream">
            <li class="list-inline-item"><a href="#"><img src="{{ asset('assets/img/detailsquare.jpg') }}" alt="..." class="img-fluid"></a></li>
            <li class="list-inline-item"><a href="#"><img src="{{ asset('assets/img/detailsquare2.jpg') }}" alt="..." class="img-fluid"></a></li>
            <li class="list-inline-item"><a href="#"><img src="{{ asset('assets/img/detailsquare3.jpg') }}" alt="..." class="img-fluid"></a></li>
            <li class="list-inline-item"><a href="#"><img src="{{ asset('assets/img/detailsquare3.jpg') }}" alt="..." class="img-fluid"></a></li>
            <li class="list-inline-item"><a href="#"><img src="{{ asset('assets/img/detailsquare2.jpg') }}" alt="..." class="img-fluid"></a></li>
            <li class="list-inline-item"><a href="#"><img src="{{ asset('assets/img/detailsquare.jpg') }}" alt="..." class="img-fluid"></a></li>
        </ul>
